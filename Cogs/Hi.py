...
class Hi(commands.Cog):
	...
	async def on_message(self, message):
		...
		elif (message.author.id == 270937744455237632 or 306125994396483587 or 311255280442933248 or 419066289298997250 or 279550029981548545 or 272318540722339840) and "привет рам" in message.content.lower():
